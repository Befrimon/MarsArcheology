...
march::Map::Map(const std::string& obj_name, const befry::Vector2& pos, const MapMode& m, const int& rect) : Sprite(obj_name, pos)
{
    size = befry::Vector2{rect, rect};
    player_position = pos + befry::Vector2{10, 1};
    color = YELLOW;
    mode = m;
}
